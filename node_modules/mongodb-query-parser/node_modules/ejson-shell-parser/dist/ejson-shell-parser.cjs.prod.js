...
var ParseMode, Checker = function Checker(options) {
    ...
    switch (node.type) {
     ...
     case "ObjectExpression":
      return node.properties.every((function(property) {
        return !property.computed && !property.method && (!![ "Literal", "Identifier" ].includes(property.key.type) && ([ "FunctionExpression", "ArrowFunctionExpression" ].includes(property.value.type) || _this.checkSafeExpression(property.value)));
      }));
  ...
  var _node$loc, source = (null === (_node$loc = node.loc) || void 0 === _node$loc ? void 0 : _node$loc.source) || "", range = node.range || [];
